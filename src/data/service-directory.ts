...
export const SERVICE_DIRECTORY: DirectoryCategory[] = [
  {
    ...
    links: [
      ...
      { label: "Invisible Grills for Apartments", href: ROUTES.service("invisible-grills-for-apartments") },
      { label: "Invisible Grills for Villas", href: ROUTES.service("invisible-grills-for-villas") },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Balcony Pigeon Nets", href: ROUTES.service("balcony-pigeon-nets") },
      { label: "Window Pigeon Nets", href: ROUTES.service("window-pigeon-nets") },
      { label: "Duct Area Pigeon Nets", href: ROUTES.service("duct-area-pigeon-nets") },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Child Safety Nets", href: ROUTES.service("children-safety-nets") },
